...
def build_prompt(
    *,
    ...
    sections = [
        ...
        "",
        "راهنمای تلفظ:",
        "استفاده دائم از این کلمات ضروری نیست",
        "این بخش فقط راهنمایی برای تلفظ درست کلماتی هست که ممکنه بهشون بر بخوری",
        "به اعراب گذاری های  ّ َ ُ ِ توجه کن تا تلفظ درست رو بفهمی",
