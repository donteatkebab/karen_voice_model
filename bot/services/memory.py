...
def build_prompt(
    *,
    ...
    sections = [
        ...
        "",
        "راهنمای تلفظ (بسیار مهم):",
        "⚠️ این بخش باید در صدای خود حتماً به تمام اطلاعات آن توجه کنی.",
        "هر کلمه، هر حرف، و هر علامت اعراب در این فهرست برای صحیح بودن تلفظ تلفظ ضروری است.",
        "نمی‌توانی از هیچ‌یک از این اطلاعات صرف‌نظر کنی — تمام آنها را مورد توجه قرار بده.",
        "به اعراب‌گذاری‌های (ّ َ ُ ِ) توجه کن تا تلفظ دقیق و صحیح را بفهمی.",
        "استفاده‌ی لفظی کلمات اجباری نیست، اما تلفظ درست آنها در خروجی صوتی الزامی است.",
        "",
        "قواعد تلفظی:",
